...
<script setup>
	...
	// stored the access key in a variable
	const WEB3FORMS_ACCESS_KEY = "d2641250-ca98-405c-842a-0e201b9dffc6";

	// stored the subject of the email to be used by web3forms
	...
	// submitForm will send a request to Web3Forms and display notyf alert
	const submitForm = async() => {
		...
		try {
			// fetch() API is used to send HTTP requests to a server
			// tech does not automatically convert the respone to JS object
			// This first argument will contain the url
			const response = await fetch("https://api.web3forms.com/submit", {
				method: "POST",
				headers: {
					"Content-type": "application/json"
				},
				// request body is not automaticaly converted into JSON
				body: JSON.stringify({
			...
			// this converts the response received from the fetch reqest from JSON to JS object
			// In axios, this process is automated
	...
	const SITE_KEY = '6LfKKLwsAAAAAMLs0Hs1ZAbhqbDYgJCTr1UOiJvD';  // Replace with your site key
